 ...
 */
 @RunWith(classOf[JUnitRunner])
  ...
  test ("my negative numbers test 1") {
    assert(max(List(-99,30, 0, -99, 34, 100)) === 100);
  }
  
  test ("my negative numbers test 2") {
    assert(sum(List(-99,30, 0, -99, 34, 100)) === -34);
  }
  
  test ("my empty test 1") {
    intercept[NoSuchElementException] {
      max(List());
    }
  }
  
  test ("my empty test 2") {
    assert(sum(List()) == 0)
  }
  
  test ("my repeat numbers test 1") {
    assert(max(List(-60,30, 30, 100)) === 100);
  }
  
  test ("my repeat numbers test 2") {
    assert(sum(List(-60,30, 30, 100)) === 100);
  }
